...
namespace Defra.UI.Tests.Steps
{
    ...
    public class DynamicsBinding
    {
        ...
        {
            Defra.Trade.Plants.SpecFlowBindings.Steps.GridSteps.CheckColumnExists(columnName, "Duplicates_subgrid");
        }
        ...
        public void ThenIVerifyTheFailedVerificationCheckErrorMessage(string Checks)
        {
            ...
            PopupSteps.WhenIClickTheButtonOnThePopupDialog("Confirm");
            SharedSteps.WaitForScriptProcessing();
            Defra.Trade.Plants.SpecFlowBindings.Steps.DialogSteps.ThenADialogIsDisplayedWithMessageInTheDialogField("Verification Check can't be failed. Couldn't find a reason to fail this check. Please add a fail reason and try again.", "dialogMessageText");
        }
        ...
        public void ThenIVerifyTheRevocationErrorMessage()
        {
            CommandSteps.ClickCommand("Revoke");
            SharedSteps.WaitForScriptProcessing();
            Defra.Trade.Plants.SpecFlowBindings.Steps.DialogSteps.ThenADialogIsDisplayedWithMessageInTheDialogField("You are about to revoke the application record. Do you want to continue with this action? This action cannot be undone.", "dialogMessageText");
            PopupSteps.WhenIClickTheButtonOnThePopupDialog("Confirm");
            SharedSteps.WaitForScriptProcessing();
            Defra.Trade.Plants.SpecFlowBindings.Steps.DialogSteps.ThenADialogIsDisplayedWithMessageInTheDialogField("Application can't be revoked. Couldn't find a reason to revoke this PTD application. Please add a reason for revocation and try again.", "dialogMessageText");
            SharedSteps.WaitForScriptProcessing();
        }
        ...
        public void ThenIVerifyTheRejectionMessages()
        {
            ...
            SharedSteps.WaitForScriptProcessing();
            Defra.Trade.Plants.SpecFlowBindings.Steps.DialogSteps.ThenADialogIsDisplayedWithMessageInTheDialogField("You are about to reject the application record. Do you want to continue with this action?", "dialogMessageText");
            PopupSteps.WhenIClickTheButtonOnThePopupDialog("Confirm");
            SharedSteps.WaitForScriptProcessing();

            Defra.Trade.Plants.SpecFlowBindings.Steps.DialogSteps.ThenADialogIsDisplayedWithMessageInTheDialogField("Application can't be rejected. Couldn't find a reason to reject this PTD application. Please add a reason for rejection and try again.", "dialogMessageText");
        }
        ...
        public void ThenISeeAnError(String errorMessage)
        {
            ...
            PopupSteps.WhenIClickTheButtonOnThePopupDialog("Confirm");
            SharedSteps.WaitForScriptProcessing(); 
            Defra.Trade.Plants.SpecFlowBindings.Steps.DialogSteps.ThenADialogIsDisplayedWithMessageInTheDialogField(errorMessage, "dialogMessageText");
            SharedSteps.WaitForScriptProcessing();
        }
