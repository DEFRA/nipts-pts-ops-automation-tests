@WelshPETS
Feature: Print Travel Document Welsh

Create a PETS travel document from Great Britain to Northern Ireland and Print the travel document in Welsh
...
Scenario Outline: Print PETS Travel Document Dog and Cat in Welsh - Pending
	...
	And I click print link in summary page in Welsh
...
Scenario Outline: Print PETS Travel Document Ferret in Welsh - Pending
	Then I have selected '<Are your details correct>' option in Welsh
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the '<MicrochipOption>' option
