...
Scenario Outline: Verify microchipped date should not allows future date in Welsh
...
Scenario Outline: Verify microchipped date should not allows older than 34 years in Welsh
	Then I have selected '<Are your details correct>' option
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the '<MicrochipOption>' option
...
Scenario Outline: Verify microchipped date text boxes should not allow invalid date in Welsh
	Then I have selected '<Are your details correct>' option
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the '<MicrochipOption>' option
...
Scenario Outline: Verify microchipped page validations without selection and should not moves to next page in Welsh
	Then I have selected '<Are your details correct>' option
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the '<MicrochipOption>' option
...
Scenario Outline: Verify microchipped page validations and should not moves to next page in Welsh
	Then I have selected '<Are your details correct>' option
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the '<MicrochipOption>' option
...
Scenario Outline: Verify microchip number should not allows less or more than 15 digits in Welsh
	Then I have selected '<Are your details correct>' option
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the '<MicrochipOption>' option
...
Scenario: Verify the input hyphen only to microchip number text box navigates to 403 error page and validate the back button in Welsh
	Then I have selected 'Yes' option
	When I click on continue button from Are your details correct page in Welsh
	Then I should redirected to the Is your pet microchipped page in Welsh
	And I selected the 'Yes' option
