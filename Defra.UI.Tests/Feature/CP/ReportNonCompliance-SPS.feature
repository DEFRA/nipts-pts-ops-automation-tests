...
Scenario: Verify Reasons heading with hint in Report non compliance page - Approved status
...
Scenario Outline: Verify SPS Outcome in Report non compliance page for Approved application
	Then I have selected 'Ferry' radio option
	And I select the 'Birkenhead to Belfast (Stena)' radio option
...
Scenario Outline: Verify SPS Outcome in Report non compliance page for unsuccessful applications
	Then I have selected 'Ferry' radio option
	And I select the '<FerryRoute>' radio option
