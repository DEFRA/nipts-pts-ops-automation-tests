...
Scenario: Verify change link click in header from Checks page and back button from homepage
	...
	And I should see date subsection 'Scheduled departure date' with the current date pre-population
	And I click back link
	And I should navigate to Checks page
