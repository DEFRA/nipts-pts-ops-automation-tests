...
Examples:
	...
	| Ferry          | Birkenhead to Belfast (Stena) | D8C1CE    | Cancelled    | Cat     | D8C 1CE^23/04/2025   | 872347623412348^12/03/2024 | ren^Cat^Mixed breed or unknown^Male^09/09/2003^Calico^No															  | Brin Pre^brindha.mathanaguru+123212@cognizant.com^30 ORTS ROAD\\r\nREADING\\r\nRG1 3JN^07541126612					 |
