...
public static class Reference
{
    ...
    public static class Timeline
    {
        ...
        public static string OpenRecord = "Timeline_Open_Record";
        public static string LatestEmailSubject = "Timeline_Latest_Email_Subject";
        public static string EmailSubjectFrame = "Timeline_Email_Subject_Frame";
