...
public static class AppReference
{
    ...
    public static class Grid
    {
        ...
        public static string AdvancedFind = "Grid_AdvancedFind";
        ...
        public static string AdvancedFindOperator = "Grid_AdvancedFindOperator";
        public static string AdvancedFindValue = "Grid_AdvancedFindValue";
        public static string AdvancedFindAddDropdown = "Grid_AdvancedFindAddDropdown";
        public static string AdvancedFindApply = "Grid_AdvancedFindApply";
    ...
    public static class Entity
    {
        ...
        public static string TextFieldAssignTo = "Entity_TextFieldAssignTo";
...
public static class AppElements
{
    public static Dictionary<string, string> Xpath = new Dictionary<string, string>()
    {
        ...
        { "Grid_AdvancedFind"    , "//*[contains(@id, \'open-advanced-filter\')]"},
        { "Grid_AdvancedFindAdd"    , "//button[contains(@id,'AddMenu')]/span"},
        { "Grid_AdvancedAddRow" , "//span[text()='Add row']" },
        { "Grid_AdvancedDeleteRow" , "//span[text()='Delete']" },
        ...
        { "Grid_AdvancedFindAddDropdown"    , "//div[@class='eb-RowExpressionView-Container']//input[@aria-label='Value']/following::i[@data-icon-name='ChevronDown']"},
        ...
        { "Grid_Columns"           , "//div[contains(@ref,'eCenterContainer')]"},
        ...
        //{ "Grid_ViewContainer"   , "//div[contains(@aria-label,'View')]" },
        ...
        { "Entity_TextFieldAssignTo", ".//*[contains(@id,\'[NAME].fieldControl-pcf-container-id\')]" },
        { "Entity_TextFieldLabel", ".//label[contains(@id, \'[NAME]-field-label\')]" },
        { "Entity_TextFieldValue", ".//input[contains(@data-id, \'[NAME].fieldControl\')]" },
        { "Entity_TextFieldLookup", ".//div[contains(@id, 'systemuserview_id.fieldControl-LookupResultsDropdown')]" },
        ...
        { "Entity_FormMessageBar", "//*[@id='notificationMessageAndButtons']/div/div/div/span" },
        ...
        { "Entity_FormNotifcationTypeIcon", ".//span[contains(@data-id,'Notification')]" },
        ...
        { "Search_GroupContainer", "//div[contains(text(), '[NAME]')]/parent::div"},
