...
public class Grid : Element
{
    ...
    /// <summary>
    /// Performs a Advanced Search on the grid
    /// </summary>
    /// <param name="field name">Name of the field to search</param>
    /// <param name="operator">operator to apply</param>
    /// <param name="value">value of the filter to apply</param>
