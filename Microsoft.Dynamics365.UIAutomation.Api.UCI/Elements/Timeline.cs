...
public class Timeline : Element
{
    ...
    public void AddNote(string title, string note)
    {
        ...
        _client.SetValue(Reference.Timeline.NoteText, note, "div");
    ...
    {
        _client.ClickCommand("Refresh");
        _client.ThinkTime(4000);
        _client.ClickButton(Elements.Xpath[Reference.Timeline.OpenRecord]);
    }


    /// <summary>
    /// Get Timeline Email Subject
    /// </summary>
    /// <returns>String</returns>
    public string GetEmailSubject()
    {
        return _client.GetLatestEmailSubject(Elements.Xpath[Reference.Timeline.LatestEmailSubject], "h1");
    }

    public ReadOnlyCollection<IWebElement> GetTimelineRecords(IWebDriver driver, string expectedElement)
    {
        return driver.FindElements(By.XPath(Reference.Timeline.RecordTitle));        
    }
}
